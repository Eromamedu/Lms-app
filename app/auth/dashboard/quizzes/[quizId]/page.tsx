...
export default function QuizPage() {
      ...
      <main className="lms-background relative min-h-screen overflow-hidden">
        <div className="relative flex min-h-[70vh] items-center justify-center">
          <div className="text-center">
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-3xl border border-white/10 bg-slate-950/80 shadow-[0_0_35px_rgba(59,130,246,0.20)]">
    ...
    return (
      <main className="lms-background relative min-h-screen overflow-hidden">
        <div className="flex min-h-[60vh] items-center justify-center">
          <div className="lms-glass rounded-3xl border border-red-400/20 p-10 text-center">
  ...
  if (questions.length === 0) {
    return (
      <main className="lms-background relative min-h-screen overflow-hidden">
        <div className="flex min-h-[60vh] items-center justify-center">
          <div className="lms-glass rounded-3xl border border-white/10 p-10 text-center">
            <h2 className="text-2xl font-bold text-white">
              No questions found
            </h2>
  ...
  return (
    <main className="lms-background relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl space-y-8">
        ...
        {/* Progress + Timer */}
        <div
          className="animate-fade-up flex flex-col gap-5 rounded-3xl border border-white/10 bg-slate-950/60 p-5 shadow-xl backdrop-blur-xl sm:p-6 md:flex-row md:items-center md:justify-between"
          style={{
        ...
        {/* Navigation */}
        <div
          className="animate-fade-up flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between"
          style={{
        ...
        >
          ...
          <button
            ...
            className="group flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-slate-950/70 px-6 py-3.5 font-semibold text-slate-300 backdrop-blur-xl transition-all duration-300 hover:border-cyan-400/30 hover:bg-slate-900 hover:text-white disabled:cursor-not-allowed disabled:opacity-30"
          >
            <ArrowLeft
              size={18}
